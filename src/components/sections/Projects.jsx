        ...
        <div className="project-list">
          {projects.map((project, index) => (
            <div key={index} className="project-item">
              <figure className="project-img-wrapper" onClick={() => openModal(project)}>
                <img 
                  src={project.image} 
                  alt={project.title} 
                ...
                <div className="project-overlay">
                  <svg className="eye-icon" width="60" height="60" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
